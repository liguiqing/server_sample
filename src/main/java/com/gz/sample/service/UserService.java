...
import com.gz.sample.repository.AuthorityRepository;
...
public class UserService {
     ...
     */
    public void updateUser(String firstName, Long mobile, String email, String langKey, String imageUrl) {
    ...
    public void accessCheck(Principal principal,String uuid){
        User user = userRepository.findOneByLogin(principal.getName()).get();
        if(!user.isSameUuid(uuid)){
            throw new AccessDeniedException("您无权查数据！");
        }
    }
