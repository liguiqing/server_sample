...
import com.gz.sample.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody ManagedUserVM userDTO) throws URISyntaxException {
        ...
        } else if (userDTO.hasEmail() && userRepository.findOneByEmailIgnoreCase(userDTO.getEmail()).isPresent()) {
