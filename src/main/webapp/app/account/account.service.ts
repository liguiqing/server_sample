...
export default class AccountService {
  ...
  public getAllAccout(): Promise<any> {
  ...
  public hasAnyAuthorityAndCheckAuth(authorities: any): Promise<boolean> {
    ...
    if (!this.authenticated || !this.userAuthorities) {
      const token = localStorage.getItem('interview-authenticationToken') || sessionStorage.getItem('interview-authenticationToken');
