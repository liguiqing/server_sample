...
import com.gz.sample.service.dto.UserDTO;
import com.gz.sample.service.mapper.UserMapper;
import com.gz.sample.web.rest.vm.ManagedUserVM;
...
public class UserResourceIT {
    ...
    private static final Long DEFAULT_LASTNAME = 130000020L;
    private static final Long UPDATED_LASTNAME = 130000021L;
    ...
    public static User createEntity(EntityManager em) {
        ...
        user.setMobile(DEFAULT_LASTNAME);
    ...
    public void createUser() throws Exception {
        ...
        managedUserVM.setUuid(System.currentTimeMillis()+"");
        managedUserVM.setPassword(DEFAULT_PASSWORD);
        managedUserVM.setName(DEFAULT_FIRSTNAME);
        managedUserVM.setMobile(DEFAULT_LASTNAME);
        ...
        assertPersistedUsers(users -> {
            ...
            assertThat(testUser.getMobile()).isEqualTo(DEFAULT_LASTNAME);
    ...
    public void updateUser() throws Exception {
        ...
        managedUserVM.setMobile(UPDATED_LASTNAME);
        ...
        assertPersistedUsers(users -> {
            ...
            assertThat(testUser.getMobile()).isEqualTo(UPDATED_LASTNAME);
    ...
    public void updateUserExistingEmail() throws Exception {
        ...
        anotherUser.setMobile(130000025L);
        ...
        managedUserVM.setMobile(updatedUser.getMobile());
    ...
    public void testUserDTOtoUser() {
        ...
        userDTO.setMobile(DEFAULT_LASTNAME);
        ...
        assertThat(user.getMobile()).isEqualTo(DEFAULT_LASTNAME);
    ...
    public void testUserToUserDTO() {
        ...
        assertThat(userDTO.getMobile()).isEqualTo(DEFAULT_LASTNAME);
        assertThat(userDTO.getEmail()).isEqualTo(DEFAULT_EMAIL);
        assertThat(userDTO.getActivated()).isEqualTo(true);
